...
namespace OrchidSeal.ParaDraw
{
    ...
    public class ShapeDrawer : UdonSharpBehaviour
    {
        ...
        {
            meshDrawer.DrawEllipticDisk(center, Quaternion.LookRotation(axisY), radius * Vector3.one, color, duration);
        }
        ...
        {
            meshDrawer.DrawEllipticDisk(center, rotation, radius * Vector3.one, color, duration);
        }
        ...
        public void DrawEllipticDisk(Vector3 center, Vector3 axisX, Vector3 axisY, Vector2 radii, Color color, float duration = 0.0f)
        {
            ...
            meshDrawer.DrawEllipticDisk(center, rotation, radii, color, duration);
        }
        ...
        public void DrawRing(Vector3 center, Vector3 axisX, Vector3 axisY, float radius, float width, float startAngle, float endAngle, Color color, float duration = 0.0f)
        {
            ...
            meshDrawer.DrawEllipticRingSection(center, rotation, radius * Vector2.one, width, startAngle, endAngle, color, duration);
        }
        ...
        {
            var rotation = Quaternion.LookRotation(-axisY, Vector3.Cross(axisX, axisY));
            meshDrawer.DrawEllipticRingSection(center, rotation, radius * Vector2.one, radius, startAngle, endAngle, color, duration);
        }
